...
export function bench_decompress(compressed_commands, iterations) {
    const ptr0 = passArray32ToWasm0(compressed_commands, wasm.__wbindgen_export2);
    const len0 = WASM_VECTOR_LEN;
...
export function bench_memory_bandwidth(data) {
    var ptr0 = passArrayF64ToWasm0(data, wasm.__wbindgen_export2);
 ...
 * @returns {number}
 */
export function bench_wasm_memory_bandwidth(elements) {
    const ret = wasm.bench_wasm_memory_bandwidth(elements);
    return ret;
}
 ...
 * @returns {number}
 */
export function calibrate_clock(iterations) {
    const ret = wasm.calibrate_clock(iterations);
    return ret >>> 0;
}
 ...
 * @returns {Uint32Array}
 */
export function generate_random_pointer_array(size) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.generate_random_pointer_array(retptr, size);
